...
def generatedby(c,logger):
    ...
    generatedby_1_2  = "AutoMated tool for Antimicrobial resistance Surveillance System (AMASS) version 3.0"
...
def annexA_A1(c,logger,result_table, org_table, pat_table,
    ...
    annexA_page1_2_1 = "Note: The list of notifiable bacteria included in the AMASS application version 3.0 was generated based on the literature review and the collaboration with Department of Disease Control, Ministry of Public Health, Thailand. The list could be expanded or modified in the next version of AMASS."
    ...
    ARC.report_title(c,'Notifiable bacteria under the survey',1.07*inch, 4.8*inch,'#3e4444',font_size=12)
